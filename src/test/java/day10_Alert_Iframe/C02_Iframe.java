...
➢ Son olarak footer : sayffanin en altindaki yer daki ‘Povered By’ yazisini varligini test edilip
    ...
    public void iframe() {
        ...
        driver.switchTo().defaultContent(); // iframeden cikmak tekrar ana sayfaya gecmek icin Switchto ya gecer defaultContent yapariz.
                                            // ic ice olan Iframe den cikmak icin de SwitchTo.parentFrame()  yapilir
        WebElement poverdbyYazisi = driver.findElement(By.xpath("//*[text()='Povered By']"));
        Assert.assertTrue(poverdbyYazisi.getText().contains("Povered By"));
    }
