...
public class C01_Waits extends TestBase {
    ...
    //bekle.ekadar.beklenen sart saglanincaya.element cliklenebilir oluncaya.
        ...
        // Textbox'in etkin oldugunu(enable) test edin
        WebElement textBoxs = driver.findElement(By.xpath("//input[@type='text']"));
        Assert.assertTrue(textBoxs.isEnabled());
